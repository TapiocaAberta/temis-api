insert into classe (id, nome, tag, descricao) values (1, "Nomeação", "NOMEACAO", "");
insert into classe (id, nome, tag, descricao) values (2, "Utilidade Pública", "UTILIDADE_PUBLICA", "");
insert into classe (id, nome, tag, descricao) values (3, "Saúde", "SAUDE", "");
insert into classe (id, nome, tag, descricao) values (4, "Acessibilidade", "ACESSIBILIDADE", "");
insert into classe (id, nome, tag, descricao) values (5, "Data comemorativa", "DATA_COMEMORATIVA", "");
insert into classe (id, nome, tag, descricao) values (6, "Educação e Cultura e Lazer", "EDUCACAO", "");
insert into classe (id, nome, tag, descricao) values (7, "Outros", "OUTRO", "");
insert into classe (id, nome, tag, descricao) values (8, "Sem Classificação", "SEM_CLASSIFICACAO", "");
insert into classe (id, nome, tag, descricao) values (9, "Causas Animais", "CAUSAS_ANIMAIS", "");
insert into classe (id, nome, tag, descricao) values (10, "Manutenção", "MANUTENCAO", "");
insert into classe (id, nome, tag, descricao) values (11, "Trânsito e Transporte", "TRANSPORTE", "");
insert into classe (id, nome, tag, descricao) values (12, "Segurança", "SEGURANCA", "");
insert into classe (id, nome, tag, descricao) values (13, "Orçamento", "ORCAMENTO", "");
insert into classe (id, nome, tag, descricao) values (14, "Alteração de Lei", "ALTERACAO_LEI", "");
insert into classe (id, nome, tag, descricao) values (15, "Congratulação", "CONGRATULACAO", "");
insert into classe (id, nome, tag, descricao) values (16, "Meio Ambiente", "MEIO_AMBIENTE", "");
insert into classe (id, nome, tag, descricao) values (17, "Urbanização", "URBANIZACAO", "");
insert into classe (id, nome, tag, descricao) values (18, "Consumidor", "CONSUMIDOR", "");
insert into classe (id, nome, tag, descricao) values (19, "Trabalho", "TRABALHO", "");
insert into classe (id, nome, tag, descricao) values (20, "Idoso", "IDOSO", "");
insert into classe (id, nome, tag, descricao) values (21, "Solicitação Médica", "SOLICITACAO_MEDICA", "");
